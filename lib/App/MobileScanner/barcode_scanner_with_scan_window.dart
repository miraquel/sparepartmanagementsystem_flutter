...
import 'package:sparepartmanagementsystem_flutter/App/MobileScanner/scanner_error_widget.dart';
...
class _BarcodeScannerWithScanWindowState extends State<BarcodeScannerWithScanWindow> {
  ...
  late NavigatorState navigator = Navigator.of(context);
  bool scanned = false;
  ...
  void initState() {
    ...
    controller.barcodes.listen((barcodeCapture) {
      if (barcodeCapture.barcodes.isNotEmpty && !scanned) {
        final scannedBarcode = barcodeCapture.barcodes.first;
        navigator.pop(scannedBarcode.displayValue);
        scanned = true;
      }
    });
  }
        ...
        children: [
          ...
          Align(
            ...
            child: Padding(
              ...
              child: Text(
                'Scan barcode within the window',
                style: const TextStyle(color: Colors.white, fontSize: 22),
              ),
            ),
          ),
          // toggle torch and switch camera
          Align(
