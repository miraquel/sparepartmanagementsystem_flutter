...
class AddAndReturnGoodsReceiptHeaderWithLinesUsecase implements UseCase<DataState<GoodsReceiptHeaderModel>, GoodsReceiptHeaderModel> {
  final GoodsReceiptRepository repository;

  AddAndReturnGoodsReceiptHeaderWithLinesUsecase(this.repository);

  @override
  Future<DataState<GoodsReceiptHeaderModel>> call({GoodsReceiptHeaderModel? params}) async {
    return await repository.addAndReturnGoodsReceiptHeaderWithLines(params!);
  }
}
