...
class UpdateGoodsReceiptHeaderWithLinesUsecase implements UseCase<DataState<String>, GoodsReceiptHeaderModel> {
  final GoodsReceiptRepository repository;

  UpdateGoodsReceiptHeaderWithLinesUsecase(this.repository);

  @override
  Future<DataState<String>> call({GoodsReceiptHeaderModel? params}) async {
    return await repository.updateGoodsReceiptHeaderWithLines(params!);
  }
}
