...
class AddGoodsReceiptHeaderWithLinesUsecase implements UseCase<DataState<String>, GoodsReceiptHeaderModel> {
  final GoodsReceiptRepository repository;

  AddGoodsReceiptHeaderWithLinesUsecase(this.repository);

  @override
  Future<DataState<String>> call({GoodsReceiptHeaderModel? params}) async {
    return await repository.addGoodsReceiptHeaderWithLines(params!);
  }
}
