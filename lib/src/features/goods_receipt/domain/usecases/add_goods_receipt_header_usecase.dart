...
class AddGoodsReceiptHeaderUsecase implements UseCase<DataState<String>, GoodsReceiptHeaderModel> {
  final GoodsReceiptRepository repository;

  AddGoodsReceiptHeaderUsecase(this.repository);

  @override
  Future<DataState<String>> call({GoodsReceiptHeaderModel? params}) async {
    return await repository.addGoodsReceiptHeader(params!);
  }
}
