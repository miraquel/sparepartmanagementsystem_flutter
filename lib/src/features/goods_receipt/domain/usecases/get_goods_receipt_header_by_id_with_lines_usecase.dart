...
class GetGoodsReceiptHeaderByIdWithLinesUsecase implements UseCase<DataState<GoodsReceiptHeaderModel>, int> {
  final GoodsReceiptRepository repository;

  GetGoodsReceiptHeaderByIdWithLinesUsecase(this.repository);

  @override
  Future<DataState<GoodsReceiptHeaderModel>> call({int? params}) async {
    return await repository.getGoodsReceiptHeaderByIdWithLines(params!);
  }
}
